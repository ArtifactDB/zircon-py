...
Welcome to `zircon-py` contributor's guide.
...
If you experience bugs or general issues with `zircon-py`, please have a look
...
You can help improve `zircon-py` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`zircon-py` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `zircon-py`'s files. While this mechanism can
...
```
conda create -n zircon-py python=3 six virtualenv pytest pytest-cov
conda activate zircon-py
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/zircon-py.git
   cd zircon-py
   ```
...
5. Install [pre-commit]:
   ...
   `zircon-py` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/zircon-py
[issue tracker]: https://github.com/<USERNAME>/zircon-py/issues
